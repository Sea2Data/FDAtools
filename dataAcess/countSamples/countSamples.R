...
makeAFWGtable <- function(samplefiles, landingsfiles, speciesSamples, speciesLanding, missiontypes=c(1,2,3,9,10,11,12,13,19), addAreas=T){
  message(paste("Extracting data for mission types:", paste(missiontypes, collapse = ",")))
  
  message("Includes Jan-Mayen zone.")
  areas <- c("00","01","02","03","04","05","06","07","10","11","12","13","14","15","16","17","18","20","21","22","23","24","25","26","27","30","34","35","36","37","38","39","50")
...
run <- function(){
  ...
  #COD
  print(makeAFWGtable(samplefiles, landingfiles, speciesSamples = c("164712"), speciesLanding = c("COD")))
  
  #CAP
  print(makeAFWGtable(samplefiles, landingfiles, speciesSamples = c("162035"), speciesLanding = c("CAP")))
